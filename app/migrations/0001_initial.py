    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership', models.CharField(choices=[('Select Options', 'Select Options'), ('Silver', 'Silver'), ('Gold', 'Gold'), ('Diamond', 'Diamond')], max_length=100)),
            ],
            bases=('app.basemodel',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_created_by', models.CharField(choices=[('Select Options', 'Select Options'), ('Myelf', 'Myself'), ('Son', 'Son'), ('Sister', 'Sister'), ('Brother', 'Brother'), ('Relative', 'Relative'), ('Friend', 'Friend')], max_length=100)),
                ('gender', models.CharField(choices=[('Select Options', 'Select Options'), ('Male', 'Male'), ('Female', 'Female')], max_length=15)),
                ...
                ('dosh', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('', 'Do not Know')], max_length=100, null=True)),
                ('height', models.CharField(max_length=100, null=True)),
                ('marital_status', models.CharField(choices=[('Select Options', 'Select Options'), ('Never Married', 'Never Married'), ('Widowed', 'Widowed'), ('Divorced', 'Divorced'), ('Awaiting Divorce', 'Awaiting Divorce')], max_length=100, null=True)),
                ('any_disability', models.CharField(choices=[('Select Options', 'Select Options'), ('None', 'None'), ('Physically Challenged', 'Physically Challenged')], max_length=100, null=True)),
                ('family_status', models.CharField(choices=[('Select Options', 'Select Options'), ('Middle Class', 'Middle Class'), ('Affluent', 'Affluent'), ('Upper Middle Class', 'Upper Middle Class'), ('Rich', 'Rich')], max_length=100, null=True)),
                ('family_type', models.CharField(choices=[('Select Options', 'Select Options'), ('Joint', 'Joint'), ('Nuclear', 'Nuclear')], max_length=100, null=True)),
                ...
                ('employed_in', models.CharField(choices=[('Select Options', 'Select Options'), ('Government/PSU', 'Government/PSU'), ('Private', 'Private'), ('Business', 'Business'), ('Defence', 'Defence'), ('Self Employed', 'Self Employed'), ('Not Working', 'Not Working')], max_length=100, null=True)),
                ...
                ('work_location', models.CharField(choices=[('Select Options', 'Select Options'), ('Indian', 'Indian')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pack', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.package')),
