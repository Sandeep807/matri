# Generated by Django 3.2.8 on 2021-10-21 05:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='registration',
            name='dosh',
            field=models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No'), ('', 'Do not Know')], max_length=100, null=True),
        ),
        migrations.AlterField(
            model_name='registration',
            name='education',
            field=models.CharField(blank=True, choices=[('Select Options', 'Select Options'), ('Aeronautical Engineering', 'Aeronautical Engineering'), ('B.Arch', 'B.Arch'), ('BCA', 'BCA'), ('B.E', 'B.E'), ('B.Plan', 'B.Plan'), ('B.Sc IT/Computer Science', 'B.Sc IT/Computer Science'), ('B.Tech', 'B.Tech'), ('Other Bacherlor Degree in Engineering/Computers', 'Other Bacherlor Degree in Engineering/Computers'), ('B.S(Engineering)', 'B.S(Engineering)'), ('M.Arch', 'M.Arch'), ('MCA', 'MCA'), ('ME', 'ME'), ('M.Sc IT/Computer Science', 'M.Sc IT/Computer Science'), ('M.S(Engg)', 'M.S(Engg)'), ('M.Tech', 'M.Tech'), ('PGDCA', 'PGDCA'), ('Other Master Degree in Engineering/Computer', 'Other Master Degree in Engineering/Computer'), ('B.A', 'B.A'), ('B.Com', 'B.Com'), ('B.Ed', 'B.Ed'), ('BFA', 'BFA'), ('BFT', 'BFT'), ('BLIS', 'BLIS'), ('B.M.M', 'B.M.M'), ('B.Sc', 'B.Sc'), ('B.S.W', 'B.S.W'), ('B.Phil', 'B.Phil'), ('M.A', 'M.A'), ('M.Sc', 'M.Sc'), ('BBA', 'BBA'), ('MBA', 'MBA'), ('Software Engineer', 'Software Engineer')], max_length=1000, null=True),
        ),
        migrations.AlterField(
            model_name='registration',
            name='employed_in',
            field=models.CharField(blank=True, choices=[('Select Options', 'Select Options'), ('Government/PSU', 'Government/PSU'), ('Private', 'Private'), ('Business', 'Business'), ('Defence', 'Defence'), ('Self Employed', 'Self Employed'), ('Not Working', 'Not Working')], max_length=100, null=True),
        ),
        migrations.AlterField(
            model_name='registration',
            name='family_status',
            field=models.CharField(blank=True, choices=[('Select Options', 'Select Options'), ('Middle Class', 'Middle Class'), ('Affluent', 'Affluent'), ('Upper Middle Class', 'Upper Middle Class'), ('Rich', 'Rich')], max_length=100, null=True),
        ),
        migrations.AlterField(
            model_name='registration',
            name='family_type',
            field=models.CharField(blank=True, choices=[('Select Options', 'Select Options'), ('Joint', 'Joint'), ('Nuclear', 'Nuclear')], max_length=100, null=True),
        ),
        migrations.AlterField(
            model_name='registration',
            name='family_value',
            field=models.CharField(blank=True, choices=[('Select Options', 'Select Options'), ('Orthodox', 'Orthodox'), ('Traditional', 'Traditional'), ('Moderate', 'Moderate'), ('Liberal', 'Liberal')], max_length=100, null=True),
        ),
        migrations.AlterField(
            model_name='registration',
            name='gender',
            field=models.CharField(blank=True, choices=[('Select Options', 'Select Options'), ('Male', 'Male'), ('Female', 'Female')], max_length=15, null=True),
        ),
        migrations.AlterField(
            model_name='registration',
            name='height',
        ...
        migrations.AlterField(
            model_name='registration',
            name='work_location',
            field=models.CharField(blank=True, choices=[('Select Options', 'Select Options'), ('Indian', 'Indian')], max_length=100, null=True),
        ),
    ]
