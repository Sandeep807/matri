...
class Registration(AbstractUser):
    ...
    mother_tongue=models.CharField(max_length=100,choices=tongue,null=True)
    caste=models.CharField(max_length=1000,choices=caste_choices,null=True)
    dosh=models.CharField(max_length=100,choices=dosh_choices,null=True)
    height=models.CharField(max_length=100,null=True)
    marital_status=models.CharField(max_length=100,choices=status_choices,null=True)
    any_disability=models.CharField(max_length=100,choices=disability_choices,null=True)
    family_status=models.CharField(max_length=100,choices=family_choices,null=True)
    family_type=models.CharField(max_length=100,choices=family_type_choices,null=True)
    family_value=models.CharField(max_length=100,choices=family_value_choices)
    education=models.CharField(max_length=1000,choices=education_choices,null=True)
    employed_in=models.CharField(max_length=100,choices=employee_choices,null=True)
    occupation=models.CharField(max_length=100,choices=occupation_choices,null=True)
    annual_income=models.CharField(max_length=1000,choices=annual_income_choices,null=True)
    work_location=models.CharField(max_length=100,choices=work_choices,null=True)
    residing_state=models.CharField(max_length=100,null=True)
    city=models.CharField(max_length=100,null=True)
    pic=models.ImageField(upload_to='matri-image')
    create_at=models.DateTimeField(auto_now_add=True)
    updated_at=models.DateTimeField(auto_now=True)
