# Generated by Django 3.2.8 on 2021-11-20 10:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_vehicle', models.CharField(blank=True, choices=[('Select Options', 'Select Options'), ('TOYOTA ETIOS', 'TOYOTA ETIOS'), ('SWIFT DZIRE', 'SWIFT DZIRE'), ('MAHINDRA VERITO', 'MAHINDRA VERITO'), ('INNOVA 6+1', 'INNOVA 6+1'), ('INNOVA 7+1', 'INNOVA 7+1'), ('TEMPO TRAVELLER', 'TEMPO TRAVELLER'), ('MINI BUS', 'MINI BUS'), ('SEDAN', 'SEDAN'), ('HATCHBACK', 'HATCHBACK')], max_length=100, null=True)),
